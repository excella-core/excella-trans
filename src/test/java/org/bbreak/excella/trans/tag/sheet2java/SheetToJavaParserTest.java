...
public class SheetToJavaParserTest extends WorkbookTest {
    ...
    public final void testSheetToJavaParser( String version) throws ParseException, IOException {
        ...
        // No.20 デフォルトコンストラクタ
        SheetToJavaParser defaultParser = new SheetToJavaParser();
