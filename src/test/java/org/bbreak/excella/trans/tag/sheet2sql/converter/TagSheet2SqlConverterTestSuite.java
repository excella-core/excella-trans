 ...
 *
 * $Id: TagSheet2SqlConverterTestSuite.java 2 2009-06-22 04:48:53Z yuta-takahashi $
 * $Revision: 2 $
 *
...
/**
 * TagSheet2SqlConverterのテストスイート
 * 
 * @since 1.0
 */
@RunWith(Suite.class)
@SuiteClasses({
    DefaultSheetToSqlDataConverterTest.class
})
public class TagSheet2SqlConverterTestSuite {
}
