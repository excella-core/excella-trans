 ...
 *
 * $Id: TagSheet2JavaTestSuite.java 2 2009-06-22 04:48:53Z yuta-takahashi $
 * $Revision: 2 $
 *
...
/**
 * Sheet2JavaParserのテストスイート
 * 
 * @since 1.0
 */
@RunWith(Suite.class)
@SuiteClasses({
    SheetToJavaParserTest.class,
    SheetToJavaSettingParserTest.class,
    SheetToJavaExecuterTest.class
})
public class TagSheet2JavaTestSuite {
}
